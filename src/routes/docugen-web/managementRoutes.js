...
const COUNT_ROUTE = SERVICES.backend.routers.docugen_web.management.count;
...
router.get(COUNT_ROUTE + NOTIFICATIONS_ROUTE, managementController.notificationsCounter);
router.post(
